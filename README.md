...
- [x] Input various users and their scores to a list
- [x] Use APIs to re-arrange the list based on the highest scores
...
```sh
  cd my-folder
  git clone https://github.com/davidolanrewaju/Leaderboard.git
```
